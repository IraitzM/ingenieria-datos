...
:::{.callout-tip}
# Esto está montado y se puede ejecutar

Todo lo que cuenta este apéndice está aplicado sobre un almacén real en el [ejercicio del lago de datos](datalake.qmd#vigilar-la-calidad): Soda vigila allí la capa oro con su imagen propia, y sus avisos acaban junto a los de dbt en un esquema `meta` del mismo DuckDB.
