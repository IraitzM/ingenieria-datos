...
![El territorio del modelado de datos, de oeste a este](../../assets/mapa_modelado.svg){width=100%}
...
Tres formas y ninguna más: el [hub]{.c-clave} guarda la lista de claves de negocio que existen, el [satélite]{.c-contexto} los atributos descriptivos con su historia, y el [enlace]{.c-relacion} el hecho de que dos conceptos estuvieron relacionados.

La particularidad frente al resto de la familia es que **agrupa el contexto en racimos**: un [satélite]{.c-contexto} lleva varios atributos juntos, normalmente los que vienen del mismo origen o cambian al mismo ritmo. Es una decisión pragmática que reduce el número de tablas a cambio de que un cambio en cualquier atributo del racimo genere una fila nueva con todos los demás repetidos.
...
* [Anclas]{.c-clave} (_anchors_), que solo contienen identidades. Equivalen al [hub]{.c-clave}, pero aún más desnudas.
* [Atributos]{.c-contexto}, una tabla por propiedad, con su propia historia. Donde Data Vault pone un [satélite]{.c-contexto} con cinco columnas, aquí hay cinco tablas.
* [Lazos]{.c-relacion} (_ties_), que relacionan anclas. Equivalen al [enlace]{.c-relacion}.
* [Nudos]{.c-valor} (_knots_), tablas pequeñas de valores compartidos y estables (estados, tipos, categorías) que se referencian desde varios sitios y evitan repetir literales. Es la única pieza sin equivalente en Data Vault.
