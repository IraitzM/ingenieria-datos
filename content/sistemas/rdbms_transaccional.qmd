...
El algoritmo [B-tree](https://es.wikipedia.org/wiki/%C3%81rbol-B) se compone de la información de la columna (o columnas deseadas) construyendo un árbol balanceado que nos permite descartar los registros cuyos valores se encuentren por encima o debajo de nuestro valor de búsqueda.
