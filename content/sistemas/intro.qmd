...
Los ingenieros tenemos cierta tendencia en centrarnos en las herramientas pero no debemos olvidar que el propósito es disponer los datos en tiempo informa para nuestros clientes, los usuarios de los datos.Veremos más en detalle estos aspectos cuando hablemos de [arquitecturas de datos](arquitecturas.qmd).